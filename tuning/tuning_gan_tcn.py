...
class Objective(object):
    """
    Tuning of the Generative Adversarial Network developed on TCN cells
    ...
    def __call__(self, trial: optuna.Trial):
        ...
        tuning_params = {"noise_dim": trial.suggest_int("noise_dim", 8, 40),
                         ...
                         # "gen_dropout_rate": trial.suggest_float("gen_dropout_rate", 0., 0.5),
                         # "dis_dropout_rate": trial.suggest_float("dis_dropout_rate", 0., 0.5),
                         "gen_dropout_rate": 0.,
                         "dis_dropout_rate": 0.,
                         "gen_num_channel": trial.suggest_int("gen_num_channel", 5, 125),
                         "dis_num_channel": trial.suggest_int("dis_num_channel", 5, 125)}
        ...
        generator = Generator(noise_dim=tuning_params["noise_dim"],
                              ...
                              cell_type="TCN",
                              num_channel=tuning_params["gen_num_channel"],
                              num_layers=tuning_params["num_layers"],
                              kernel_size=tuning_params["kernel_size"],
                              dropout_rate=tuning_params["gen_dropout_rate"],
                              mean=data_mean,
        ...
        discriminator = Discriminator(condition_size=tuning_params["condition_size"],
                                      ...
                                      cell_type="TCN",
                                      num_channel=tuning_params["dis_num_channel"],
                                      num_layers=tuning_params["num_layers"],
                                      kernel_size=tuning_params["kernel_size"],
                                      dropout_rate=tuning_params["dis_dropout_rate"],
                                      mean=data_mean,
                                      std=data_std).to(self.device)
