...
class Objective(object):
    """
    Tuning of the Adversarial auto-encoder developed on RNN cells
    ...
    def __call__(self, trial: optuna.Trial):
        ...
        encoder = Encoder(condition_size=tuning_params["condition_size"],
                          ...
                          hidden_layer_depth=tuning_params["enc_hidden_depth"],
        ...
        decoder = Decoder(condition_size=tuning_params["condition_size"],
                          ...
                          hidden_layer_depth=tuning_params["dec_hidden_depth"],
                          latent_length=tuning_params["latent_length"],
                          cell_type=tuning_params["cell_type"],
