...
class Objective(object):
    """
    Tuning of the Variational auto-encoder developed on RNN cells
    ...
    def __call__(self, trial: optuna.Trial):
        ...
        tuning_params = {"enc_size": trial.suggest_categorical("enc_hidden_size", [8, 16, 32, 64, 128, 512]),
                         "enc_hidden_depth": trial.suggest_int("enc_hidden_depth", 2, 3),
                         "dec_size": trial.suggest_categorical("dec_hidden_size", [8, 16, 32, 64, 128, 512]),
                         "dec_hidden_depth": trial.suggest_int("dec_hidden_depth", 2, 3),
        ...
        model = VAEModel(condition_size=tuning_params["condition_size"],
                         ...
                         enc_hidden_layer_depth=tuning_params["enc_hidden_depth"],
                         dec_hidden_layer_depth=tuning_params["dec_hidden_depth"],
